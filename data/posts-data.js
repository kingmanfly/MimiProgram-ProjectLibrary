...
var local_database = [
    {
        date: "Sep 18 2016",
        title: "正是虾肥蟹壮时",
        imgSrc: app.globalData.urlBase + 'post/crab.png',
        avatar: app.globalData.urlBase + 'post/1.png',
        content: "菊黄蟹正肥，品尝秋之味。徐志摩把,“看初花的荻芦”和“到楼外楼吃蟹”,并列为秋天来杭州不能错过的风雅之事；用林妹妹的话讲是“螯封嫩玉双双满，",
        reading: "112",
        collection: "96",
        headImgSrc: app.globalData.urlBase + 'post/crab.png',
        author: "林白衣",
        dateTime: "24小时前",
    ...
    },
    {
        ...
        imgSrc: app.globalData.urlBase + 'post/bl.png',
        reading: 62,
        ...
        collection: 92,
        dateTime: "24小时前",
        headImgSrc: app.globalData.urlBase + 'post/bl.png',
        author: "迷的城",
        date: "Nov 20 2016",
        avatar: app.globalData.urlBase + 'post/1.png',
        postId: 1,
    ...
    },
    {
        ...
        imgSrc: app.globalData.urlBase + 'post/sls.jpg',
        headImgSrc: app.globalData.urlBase + 'post/sls.jpg',
        reading: 62,
        collection: 92,
        author: "知乎",
        date: "Nov 12 2016",
        dateTime: "三天前",
        avatar: app.globalData.urlBase + 'post/3.png',
        postId: 2,
        music: {
    ...
    },
    {
        ...
        imgSrc: app.globalData.urlBase + 'post/xiaolong.jpg',
        reading: 102,
        ...
        collection: 92,
        dateTime: "24小时前",
        headImgSrc: app.globalData.urlBase + 'post/xiaolong.jpg',
        author: "猫是猫的猫",
        date: "Nov 20 2016",
        avatar: app.globalData.urlBase + 'post/5.png',
        postId: 3,
        music: {
    ...
    },
    {
        ...
        imgSrc: app.globalData.urlBase + 'post/vr.png',
        reading: 102,
        ...
        collection: 26,
        dateTime: "24小时前",
        headImgSrc: app.globalData.urlBase + 'post/vr.png',
        author: "深白色",
        date: "Nov 20 2016",
        avatar: app.globalData.urlBase + 'post/3.png',
        postId: 4,
    ...
    },
    {
        ...
        imgSrc: app.globalData.urlBase + 'post/iqiyi.png',
        reading: 96,
        ...
        collection: 26,
        dateTime: "21小时前",
        headImgSrc: app.globalData.urlBase + 'post/iqiyi.png',
        author: "深白色",
        date: "Nov 20 2016",
        avatar: app.globalData.urlBase + 'post/5.png',
        postId: 5,
